...
_SYSTEM = """\
당신은 광고 품질 검증 전문가입니다.
광고 문구를 7개 항목으로 평가하고 반드시 JSON 형식으로만 응답하세요."""

_USER_TEMPLATE = """\
아래 광고 문구를 7개 항목으로 검증하세요.
...
{{
  ...
  "brand_consistency": {{"passed": bool, "score": 0.0~1.0, "feedback": "설명"}}
}}
...
async def check_quality(
    ...
    items = {
        ...
        "brand_consistency": _parse_item(raw.get("brand_consistency", {})),
    }
