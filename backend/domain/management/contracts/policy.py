...
TIER_POLICY: dict[str, ActionTier] = {
    "GET_INSIGHTS": ActionTier.TIER0,
    "PREVIEW_AD": ActionTier.TIER0,
    "PAUSE_CAMPAIGN": ActionTier.TIER1,
    "DECREASE_BUDGET": ActionTier.TIER1,
    "REBALANCE_BUDGET": ActionTier.TIER2,  # 비활성 (7/8 스코프 제외)
    "INCREASE_BUDGET": ActionTier.TIER3,
    "REPLACE_CREATIVE": ActionTier.TIER3,
}

AUTO_APPROVE_MAX_TIER = ActionTier.TIER1
