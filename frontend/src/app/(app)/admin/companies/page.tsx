  ...
  return (
    <div className="px-8 py-8 max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-[#8B95A1] dark:text-[#6B7280] mt-1">전체 조직을 조회·관리하세요</p>
      </div>
      ...
      <div className="bg-white dark:bg-[#1C2333] border border-[#E5E8EB] dark:border-[#2D3748] rounded-2xl overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="py-16 text-center text-sm text-[#8B95A1] dark:text-[#6B7280]">활성 조직이 없습니다</div>
        ) : (
            ...
            <tbody>
              {activeOrgs.map((o) => (
                <tr key={o.id} className="border-b border-[#F9FAFB] dark:border-[#1C2333] last:border-0 hover:bg-[#F9FAFB] dark:hover:bg-[#252D3D] transition-colors">
                  ...
                  <td className="px-4 py-4 text-[#8B95A1] dark:text-[#6B7280]">{formatKSTDate(o.created_at)}</td>
      ...
      {inactiveOrgs.length > 0 && (
        <div className="bg-white dark:bg-[#1C2333] border border-red-100 dark:border-red-900/30 rounded-2xl overflow-hidden">
          <div className="px-6 py-4 border-b border-[#E5E8EB] dark:border-[#2D3748]">
            <p className="text-sm font-semibold text-red-500">비활성화된 조직</p>
            <p className="text-xs text-[#8B95A1] dark:text-[#6B7280] mt-0.5">복원하거나 영구 삭제할 수 있습니다</p>
          </div>
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#F2F4F6] dark:border-[#252D3D] bg-[#F9FAFB] dark:bg-[#252D3D]">
