...
type PendingMember = { member_id: string; user_id: string; user_name: string; login_id: string; created_at: string };
              ...
              <tbody>
                {pending.map((m) => (
                  <tr key={m.member_id} className="border-b border-[#F9FAFB] dark:border-[#1C2333] last:border-0 hover:bg-[#F9FAFB] dark:hover:bg-[#252D3D] transition-colors">
                    ...
                    <td className="px-4 py-4 text-[#4E5968] dark:text-[#9CA3AF]">{m.login_id}</td>
